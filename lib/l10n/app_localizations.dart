...
class AppLocalizations {
  ...
  static const _en = <String, String>{
    ...
    'PEOPLE': 'PEOPLE',
    'Always on': 'Always on',
    'Can book classes and view the schedule': 'Can book classes and view the schedule',
    'Has a coach portal with class planning & check-in': 'Has a coach portal with class planning & check-in',
    'Access to admin panel and management tools': 'Access to admin panel and management tools',
    'Full access — manages members, offers and settings': 'Full access — manages members, offers and settings',
    'Opens 30 min before class · valid until end': 'Opens 30 min before class · valid until end',
    'QR code data copied': 'QR code data copied',
    'Copy QR data': 'Copy QR data',
    'Members scan this to check in': 'Members scan this to check in',
    'Display this at the gym entrance': 'Display this at the gym entrance',
    'Got it': 'Got it',
    'INVOICE': 'INVOICE',
    'Invoice #': 'Invoice #',
    'Issued': 'Issued',
    ...
    'Clear expiry': 'Clear expiry',
    'Balance due': 'Balance due',
    'Paid / Total due': 'Paid / Total due',
    'Search member, invoice #, plan…': 'Search member, invoice #, plan…',
    'Apply': 'Apply',
    'Mon': 'Mon',
    'Tue': 'Tue',
    'Wed': 'Wed',
    ...
    'Finance': 'Finance',
    'With plan': 'With plan',
    'Expiring ≤14d': 'Expiring ≤14d',
    'CIN / Passport': 'CIN / Passport',
    'Edit\nProfile': 'Edit\nProfile',
    'Assign\nOffer': 'Assign\nOffer',
    'Record\nPayment': 'Record\nPayment',
    'All\nOffers': 'All\nOffers',
    ...
    'Phone Number': 'Phone Number',
    'CIN / Passport Number': 'CIN / Passport Number',
    'Fitness Level': 'Fitness Level',
    'Health Notes / Injuries': 'Health Notes / Injuries',
    ...
    'Check-In Screen': 'Check-In Screen',
    'Class QR': 'Class QR',
    'Add Booking': 'Add Booking',
    'Message Booked': 'Message Booked',
    'Checked-In': 'Checked-In',
    'No Shows': 'No Shows',
  ...
  static const _fr = <String, String>{
    ...
    'Fitness level': 'Niveau fitness',
    'Beginner': 'Débutant',
    'Intermediate': 'Intermédiaire',
    'RX': 'RX',
    'Contact name': 'Nom du contact',
    'Contact phone': 'Téléphone de contact',
    'Health notes': 'Notes santé',
    ...
    'No active plans found. Create one in Offers first.':
        'Aucun abonnement actif trouvé. Créez-en un dans Offres d\'abord.',
    'Apply': 'Appliquer',
    'Mon': 'Lun',
    'Tue': 'Mar',
    'Wed': 'Mer',
    ...
    'With plan': 'Avec plan',
    'Expiring ≤14d': 'Expirant ≤14j',
    'CIN / Passport': 'CIN / Passeport',
    'Edit\nProfile': 'Modifier\nProfil',
    'Assign\nOffer': 'Assigner\nOffre',
    'Record\nPayment': 'Enregistrer\nPaiement',
    'All\nOffers': 'Toutes\nOffres',
    ...
    'Phone Number': 'Numéro de téléphone',
    'CIN / Passport Number': 'Numéro CIN / Passeport',
    'Fitness Level': 'Niveau fitness',
    'Health Notes / Injuries': 'Notes santé / Blessures',
    'Contact Full Name': 'Nom complet contact',
    'Contact Phone': 'Téléphone contact',
    'Revenue Today': 'Revenu aujourd\'hui',
    'Outstanding': 'Impayé',
    'Collection Rate': 'Taux de collecte',
    'Check-In Screen': 'Écran check-in',
    'Class QR': 'QR du cours',
    'Add Booking': 'Ajouter réservation',
    'Message Booked': 'Envoyer message',
    'Checked-In': 'Présent',
    'No Shows': 'Absences',
    ...
    'Attendance History': 'Historique présence',
    'INVOICE': 'FACTURE',
    'Invoice #': 'Facture n°',
    'Issued': 'Émise le',
    'Due': 'Échéance',
